...
* [一、一个简单的例子](#一、一个简单的例子)
	* [1、实现功能](#1、实现功能)
	* [2、初始化项目](#2、初始化项目)
	* [3、创建相关实体和DAO](#3、创建相关实体和DAO)
	* [4、Controller实现](#4、Controller实现)
	* [5、SpringSecurity的配置](#5、SpringSecurity的配置)
	* [6、方便将已认证用户注入到Controller参数](#6、方便将已认证用户注入到Controller参数)
	* [7、注册HandlerMethodArgumentResolver和登录视图](#7、注册HandlerMethodArgumentResolver和登录视图)
	* [8、SpringSecurity工作流程](#8、SpringSecurity工作流程)
	* [9、其他相关坑](#9、其他相关坑)
* [二、JavaConfig](#二、JavaConfig)
	* [0、JavaConfig通用方式](#0、JavaConfig通用方式)
	* [1、展示示例](#1、展示示例)
	* [2、HttpSecurity](#2、HttpSecurity)
	* [3、WebFlux Security](#3、WebFlux Security)
	* [4、验证](#4、验证)
	* [5、OAuth 2.0登录](#5、OAuth 2.0登录)
	* [6、RememberMe](#6、RememberMe)
* [三、实现逻辑和核心接口核心类](#三、实现逻辑和核心接口核心类)
	* [1、执行路径](#1、执行路径)
	* [2、核心类概述](#2、核心类概述)
	* [3、核心接口概述](#3、核心接口概述)
	* [4、内部提供的常用的类和工具](#4、内部提供的常用的类和工具)
* [四、SpringSecurity测试](#四、SpringSecurity测试)
	* [1、依赖](#1、依赖)
	* [2、@WithMockUser](#2、@WithMockUser)
	* [3、@WithUserDetails](#3、@WithUserDetails)
	* [4、自定义测试注解](#4、自定义测试注解)
